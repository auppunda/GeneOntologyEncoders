...
for fold in 1 ; do 
  ...
  result_folder=$data_dir/'FlatSeqProtHwayElmo2768.'$ontology
  prot2seq_model_load=$result_folder/'best_state_dict.pytorch'

  # ## continue training save to a new place
  result_folder=$data_dir/'FlatSeqProtHwayElmo3768.'$ontology
  mkdir $result_folder
