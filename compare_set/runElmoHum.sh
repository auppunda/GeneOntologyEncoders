...
pair='HumanPPI3ontology' # 'HumanMouse'
outDir=$server/$pair'/qnliFormatData17'
mkdir $outDir
...
for point in {4900..4900..50} # 12600
do
...
#for point in {0..12600..300} # 12600
#do
...
#CUDA_VISIBLE_DEVICES=5 /local/auppunda/anaconda3/bin/python ElmoC/encoder/do_model.py --vocab_list $vocab_list --w2v_emb $w2v_emb --bilstm_dim 1024 --main_dir $work_dir --qnli_dir $data_dir --batch_size_label 128  --pregenerated_data $pregenerated_data --result_folder $result_folder --epoch 0 --num_train_epochs_entailment 0 --use_cuda --metric_option $metric_option --def_emb_dim $def_emb_dim  --model_load $model_load --write_score $write_score --test_file $test_file
